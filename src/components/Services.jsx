        ...
        <Section id='how-to-use'>
            <div className="container">
                <Heading
                    ...
                    text="Brainwave unlocks de potential of 
                ...
                <div className="relative">
                    ...
                    mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
                        ...
                        h-full pointer-events-none md:w-3/5 lx:w-auto">
                        ...
                        <div className="relative z-1 max-w-[17rem] ml-auto">
                            ...
                            <p className="body-2 mb-[3rem] text-n-3">
                                Brainwave unlocks de potential of AI-powered applications
                            </p>
                    ...
                    <div className="relative z-1 grid gap-5 lg:grid-cols-2">
                        <div className="relative min-h-[39rem] border boder-n-1/10 rounded-3xl overflow-hidden">
